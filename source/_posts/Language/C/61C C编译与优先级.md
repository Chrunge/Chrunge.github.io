...
password:
description: How to compile a C program
tags:
- C
categories:
- Language
...
text区域是程序的指令，data区域存放的是初始化了的全局变量，BSS包含了未被初始化或者初始化为0的全局变量。

![](app://local/D:/ALearning/obsidian/Post/Language/C/Attachments/Pasted%20image%2020220830105705.png?1684374672123)
