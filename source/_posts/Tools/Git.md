...
![Git常用命令速查表](https://raw.githubusercontent.com/Chrunge/Chrunge.github.io/dev/source/_posts/Tools/Attachments/Git常用命令速查表.jpg)
<!-- more -->
## 2. **创建版本库**
...
3. `git reset --hard commit_id`切换到`commit_id`，并改变Working Directory和Stage的内容（相当于`commit_id`之后修改的内容全部丢弃）
   ...
   ![reset_soft](https://raw.githubusercontent.com/Chrunge/Chrunge.github.io/dev/source/_posts/Tools/Attachments/reset_soft.gif)
...
5.	`git fetch`：下载所有的提交记录到本地的各个远程分支;
	![fetch](https://raw.githubusercontent.com/Chrunge/Chrunge.github.io/dev/source/_posts/Tools/Attachments/fetch.gif)
...
8. `cherry pick commit_id1 commit_id2 ...`：将commit_id依次**复制添加**到当前分支  
	![cherry_pick](https://raw.githubusercontent.com/Chrunge/Chrunge.github.io/dev/source/_posts/Tools/Attachments/cherry_pick.gif)上
...
9. `git rebase branch_name`：以`branch_name`为base，将分叉后的所有commit剪切上去。
   ...
   ![rebase](https://raw.githubusercontent.com/Chrunge/Chrunge.github.io/dev/source/_posts/Tools/Attachments/rebase.gif)
...
1. git通常会用fast forward模式，在这种情况下，删除分支之后，会丢掉分叉时的信息(`git merge <name>`)
   ![fast forward](https://raw.githubusercontent.com/Chrunge/Chrunge.github.io/dev/source/_posts/Tools/Attachments/fast_forward.gif)
