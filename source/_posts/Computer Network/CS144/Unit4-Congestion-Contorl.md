...
2. multiple flow
   1. ![one flow vs multiple flow](https://github.com/Chrunge/Pictures/blob/master/CS144/4/one%20flow%20vs%20multiple%20flow.PNG?raw=true)
      1. ![Simple geometric intuition](https://github.com/Chrunge/Pictures/blob/master/CS144/4/Simple%20geometric%20intuition.PNG?raw=true)
...
2. TCP Tahoe's three improvements:
   1. Congestion window
      ...
      2. ![TCP Tahoe FSM](https://github.com/Chrunge/Pictures/blob/master/CS144/4/TCP%20Tahoe%20FSM.PNG?raw=true)
   2. Timeout estimation 
      1. ![TCP Tahoe Timeouts](https://github.com/Chrunge/Pictures/blob/master/CS144/4/TCP%20Tahoe%20Timeouts.PNG?raw=true)
   3. Self-clocking
...
4. Three Mechanisms: fast retransmit, fast recovery, 
   1. ![Three Mechanism](https://github.com/Chrunge/Pictures/blob/master/CS144/4/Three%20Mechanism.PNG?raw=true)
   2. ![TCP Tahoe](https://github.com/Chrunge/Pictures/blob/master/CS144/4/TCP%20Tahoe.PNG?raw=true)
   3. ![TCP Reno](https://github.com/Chrunge/Pictures/blob/master/CS144/4/TCP%20Reno.PNG?raw=true)
   4. ![Congestion Window Inflation](https://github.com/Chrunge/Pictures/blob/master/CS144/4/Congestion%20Window%20Inflation.PNG?raw=true)
   5. ![TCP Reno FSM](https://github.com/Chrunge/Pictures/blob/master/CS144/4/TCP%20Reno%20FSM.PNG?raw=true)